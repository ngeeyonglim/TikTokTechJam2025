...
def update_data():
    ...
    # While this is just overwriting the file, in a real application
    # you might want to append or modify existing data, or store it in
    # a more durable way (like a database) 
